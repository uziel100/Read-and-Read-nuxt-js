        ...
        <v-expansion-panel class="pa-0">
          ...
          <v-expansion-panel-content>
            ...
            <v-select
              ...
              outlined
            ></v-select>
            <v-btn @click="doAdvancedSearch" color="primary" class="text-none"> Realizar busqueda </v-btn>
          </v-expansion-panel-content>
        </v-expansion-panel>
      </v-expansion-panels>
    </v-sheet>
  ...
  methods: {
    ...
    async doAdvancedSearch(){
      ...
      if( this.form.title && this.form.author && this.form.category ){
        this.loading = true;
        try {
          const res = await this.$axios.$get(`book/advanceSearch?title=${ this.form.title }&author=${ this.form.author._id }&category=${ this.form.category._id }`) 
